            ...
            for cache_dir in possible_cache_dirs.iter() {
                ...
                match target_dir_for_checkout {
                    Some(ref checkout_target_dir) => {
                        debug!("target_dir_for_checkout = {}", checkout_target_dir.display());
                        ...
                        debug!("a. source_workspace = {} destination_workspace = {}",
                               source_workspace.display(), destination_workspace.display());
                        // Strip off the build/<target-triple> part to get the workspace
                        destination_workspace = source_workspace.clone();
                        debug!("b. source_workspace = {} destination_workspace = {}",
                               source_workspace.display(), destination_workspace.display());

                        destination_workspace.pop();
                        debug!("c. source_workspace = {} destination_workspace = {}",
                               source_workspace.display(), destination_workspace.display());

                        destination_workspace.pop();
                        debug!("d. source_workspace = {} destination_workspace = {}",
                               source_workspace.display(), destination_workspace.display());
                        ...
                        debug!("Just assigned start_dir with {}",
